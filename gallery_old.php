    ...
    <body class="archive" cz-shortcut-listen="true">
        <div class="wrapper-container">
            ...
            <div class="site wrapper-content">
                <div class="top_site_main" style="background-image:url(images/banner/gallery.png);">
						...
						<div class="sc-gallery wrapper_gallery">
							...
							<div class="row content_gallery">
                                                            ...
                                                            <div class="col-sm-4 gallery_item-wrap competitions gears">
                                                                <a href="images/gallery/<?php echo $gallery["image_name"];?>" class="swipebox" title="<?php echo $gallery["caption"];?>">
                                                                    <img src="images/gallery/<?php echo $gallery["image_name"];?>" alt="">
