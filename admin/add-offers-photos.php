...
if (isset($_POST['save-data'])) {
    ...
    $addphoto = addNewoffersPhoto($_POST, $_FILES);
    ...
    <div class="container">
        ...
        <div class="panel panel-default"> 
            <div class="panel-body"> 
                ...
                <div class="row"> 
                    <?php
                    $offerPhotos = getAlloffersPhotos($id);

                    if (count($offerPhotos) > 0) {
                        foreach ($offerPhotos as $img) {
                            ?>
                            <div class="col-md-3 col-sm-4 col-xs-6">
                                <div class="slider-image">
                                    <a class="info" class="example-image-link" data-lightbox="example-set"  href="../images/offers/gallery/<?php echo $img["image_name"]; ?>" > 
                                        <img class="example-image img-responsive" src="../images/offers/gallery/thumb/<?php echo $img["image_name"]; ?>" alt=""/> 
                                    </a> 
                                </div>  
                                ...
                                <div class="image-option " > 
                                    ...
                                    <a href="edit-offers-photos.php?id=<?php echo $img["id"]; ?>"><button class="glyphicon glyphicon-pencil edit"></button></a>
                                    <a href="arrange-offers-photos.php?id=<?php echo $id; ?>"><button class="glyphicon glyphicon-sort pictuers"></button></a>
                                </div>
