...
if (isset($_POST['save-data'])) {
    ...
    $editPack = updateOnePackagePhoto($_POST, $_FILES);
...
$editPack = getOnePackagePhoto($id);
...
<div class="content-wrapper">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Manage Pacage Photos </h1>
            </div>
        </div>
        <!--end banner-->
                    ...
                    <div class="panel-body">
                        <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <img src="../images/packages/gallery/<?php echo $editPack['image_name']; ?>" class="img-responsive"/>
                            </div> 
