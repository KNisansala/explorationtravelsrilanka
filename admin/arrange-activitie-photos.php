...
if (isset($_POST['save-date'])) {
    ...
    foreach ($_POST['sort'] as $key => $img) {
        $key = $key + 1;
        $sql = "UPDATE `activities_photos` SET `sort` = '" . $key . "'  WHERE id = '" . $img . "'";
        $db = new DB();
        $db->readQuery($sql);
    }
}
...
<div class="content-wrapper">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Arrange Photos </h1>
            </div>
        </div>
        <!--end banner-->
                                            ...
                                            if (count($activitiePhotos) > 0) {
                                                foreach ($activitiePhotos as $key => $img) {
                                                    ...
                                                    <li class="ui-state-default">
                                                        ...
                                                        <img width="300px" height="130" class="example-image img-responsive" src="../images/activities/gallery/thumb/<?php echo $img["image_name"]; ?>" alt=""/>
