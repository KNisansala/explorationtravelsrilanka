...
$packagePhotos = getAllPackagesPhotos($id);
                                            ...
                                            if (count($packagePhotos) > 0) {
                                                foreach ($packagePhotos as $key => $img) {
                                                    ...
                                                    <li class="ui-state-default">
                                                        ...
                                                        <img width="300px" height="130" class="example-image img-responsive" src="../images/packages/gallery/thumb/<?php echo $img["image_name"]; ?>" alt=""/>
